...
const settings = {
  ...
  TIME_CLAIM: process.env.TIME_CLAIM ? parseInt(process.env.TIME_CLAIM) : 240,
  ...
  AUTO_CLAIM_ONCHAIN: process.env.AUTO_CLAIM_ONCHAIN ? process.env.AUTO_CLAIM_ONCHAIN.toLowerCase() === "true" : false,
